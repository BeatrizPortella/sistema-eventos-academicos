...
<div class="row mb-4 align-items-center">
    ...
    <div class="col-md-6">
        <form action="index.php" method="GET" class="d-flex">
            <input type="text" name="busca" class="form-control me-2" placeholder="Buscar eventos por nome..."
                ...
                <div class="card h-100">
                    ...
                    <div class="card-footer bg-transparent border-top-0 pb-3">
                        <button class="btn btn-outline-primary btn-sm w-100" data-bs-toggle="modal"
                            data-bs-target="#modalEvento<?php echo $evento['id']; ?>">Ver Detalhes</button>
                    </div>
                </div>
            </div>

            <!-- Modal Detalhes Evento -->
            <div class="modal fade" id="modalEvento<?php echo $evento['id']; ?>" tabindex="-1"
                aria-labelledby="modalLabel<?php echo $evento['id']; ?>" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header bg-primary text-white">
                            <h5 class="modal-title" id="modalLabel<?php echo $evento['id']; ?>">
                                <?php echo htmlspecialchars($evento['titulo']); ?></h5>
                                    ...
                                    <?php foreach ($apresentacoes as $ap): ?>
                                        <li class="list-group-item d-flex justify-content-between align-items-start">
                                            <div class="ms-2 me-auto">
                                                ...
                                                <small class="text-muted">Palestrante:
                                                    <?php echo htmlspecialchars($ap['palestrante']); ?></small>
                                            </div>
                                            <span
                                                class="badge bg-secondary rounded-pill"><?php echo date('H:i', strtotime($ap['horario'])); ?></span>
                                        </li>
                                    <?php endforeach; ?>
                                </ul>
                            <?php else: ?>
